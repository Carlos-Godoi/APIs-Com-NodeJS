// Importando a class MongoClient do pacote 'mongodb'
const { MongoClient } = require('mongodb');

// Conexão com o MongoDB, usando o MongoDB Atlas (nuvem).
const uri = 'mongodb+srv://ccarlosgodoii_db_user:vzamUzE4pkelbpMH@cluster0.s5jte4y.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0';
...
async function conectarMongo() {
    try {
        ...
        // Agora que temos o banco de dados, acessamos a coleção 'pessoas' e armazenamos em 'pessoasCollection';
...
// especialmente nas rotas onde precisamos interagir com a coleção 'pessoas' no MongoDB.
