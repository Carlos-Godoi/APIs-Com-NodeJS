// Exportar a dependência do Express
const express = require('express');

// Criar um objeto de rota
const router = express.Router();

// Importar o ObjectId, necessário para trabalhar com os _id dos documentos MongoDb[
const { ObjectId } = require('mongodb');

// Ter acesso a função responsável por obter os dados via MongoDB
const { getPessoasCollection } = require('../conexao/mongo');

// Função auxuliar para validar o ObjectId
...
router.post('/', async(req, res) => {
    ...
    try {
        ...
        res.status(201).json({ id: resultado.insertId, nome, idade, cidade });
    } catch (err) {
...
// PATCH /pessoas/:codigo - Atualizar parcialmente os campos de uma pessoa
