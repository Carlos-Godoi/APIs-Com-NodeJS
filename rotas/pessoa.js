...
router.put('/:codigo', (req, res) => {
    ...
    // Caso o nome, idade ou cidade não sejam informados, retorna status 400
    if(!nome || !idade || !cidade) {
...
// Rota para atualizar parcialmente as informações de uma pessoa
...
router.delete('/:codigo', (req, res) => {
    ...
    // Localizar o índice da pessoa com o código recebido via parâmetro
    const indicePessoa = pessoas.findIndex(p => p.codigo === codigo);
